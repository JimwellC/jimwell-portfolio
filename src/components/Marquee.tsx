...
const items = [
  { label: "React Native", sub: "mobile" },
  { label: "Flutter",      sub: "cross-platform" },
  { label: "NestJS",       sub: "backend" },
  { label: "Node.js",      sub: "runtime" },
  { label: "TypeScript",   sub: "language" },
  { label: "Dart",         sub: "language" },
  { label: "Python",       sub: "scripting" },
  { label: "WebSockets",   sub: "real-time" },
  { label: "Socket.IO",    sub: "live data" },
  { label: "PostgreSQL",   sub: "database" },
  { label: "Redis",        sub: "caching" },
  { label: "Firebase",     sub: "realtime db" },
  { label: "Angular",      sub: "frontend" },
];
