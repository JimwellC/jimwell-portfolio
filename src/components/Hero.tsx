          ...
          >
            ...
            >
              ...
              <div style={{
                ...
                background: "linear-gradient(transparent, rgba(8,9,16,0.9))",
              }}>
                <div style={{ fontSize: "16px", fontWeight: 600, color: "#eaecf6", marginBottom: "2px" }}>
                  Jimwell Calma
                </div>
                <div style={{
      ...
      <section style={{
        ...
        <div className="col" style={{ paddingTop: "72px", paddingBottom: "64px", position: "relative" }}>
          ...
          <div style={{
            ...
            {/* Photo */}
            <motion.div
              variants={f} custom={0} initial="hidden" animate="show"
            ...
            >
              <div
                ...
                onMouseEnter={e => e.currentTarget.style.boxShadow = "0 0 0 3px rgba(99,102,241,0.3)"}
                onMouseLeave={e => e.currentTarget.style.boxShadow = "0 0 0 3px rgba(99,102,241,0.1)"}
              >
                <Image
                  src="/images/jimwell.jpg"
                  alt="Jimwell Calma"
            ...
            <motion.div variants={f} custom={0} initial="hidden" animate="show">
              <div style={{ fontSize: "12px", fontWeight: 500, color: "#eaecf6", marginBottom: "2px" }}>
                Jimwell Calma
              </div>
              <div style={{
                fontFamily: "var(--font-space-mono)", fontSize: "10px",
                letterSpacing: "0.06em", textTransform: "uppercase",
                color: "var(--a2)", opacity: 0.7,
              }}>
          ...
          >
            ...
            <em className="not-italic" style={{
              WebkitTextStroke: "1.5px rgba(129,140,248,0.55)",
              color: "transparent",
            }}>move fast.</em>
          </motion.h1>
          ...
          {/* Subheading */}
          <motion.p
            variants={f} custom={2} initial="hidden" animate="show"
            style={{
              fontSize: "15px", color: "var(--muted)", lineHeight: 1.75,
              maxWidth: "480px", fontWeight: 300, marginBottom: "36px",
            }}
          >
            Real-time auction platforms. TikTok selling automation. Emergency
            apps for people who need them most. I care about{" "}
          ...
          {/* CTAs */}
          <motion.div
            variants={f} custom={3} initial="hidden" animate="show"
            style={{ display: "flex", gap: "10px", flexWrap: "wrap", marginBottom: "36px" }}
          >
            <a href="#work" style={{
              padding: "11px 26px", borderRadius: "100px", fontSize: "14px",
            ...
            <a href="/resume.pdf" target="_blank" rel="noopener noreferrer" style={{
              ...
              <span style={{ fontSize: "12px" }}>↓</span> Download CV
            </a>
          ...
          {/* Divider */}
          <div style={{ height: "0.5px", background: "var(--border)", marginBottom: "24px" }}/>

          {/* Meta links */}
          <motion.div
            variants={f} custom={4} initial="hidden" animate="show"
